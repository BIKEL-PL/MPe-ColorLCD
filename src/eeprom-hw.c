...
#ifdef USE_WITH_560C
#define EEPROM_START_ADDRESS            0x0803F000
#define EEPROM_START_ADDRESS_PAGE_0     0x0803F000
#define EEPROM_START_ADDRESS_PAGE_1     0x0803F800 // last page of 2kbytes of flash memory
#endif
