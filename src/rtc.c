...
uint16_t rtc_editTime_hour = 0, rtc_editTime_min = 0;
static rtc_time_t rtc_editTimeLast;
...
{
	rtc_editTime_hour = rtc_editTimeLast.ui8_hours = hour;
	rtc_editTime_min = rtc_editTimeLast.ui8_minutes = min;
}
void rtc_synchro(void)
{
	if (rtc_editTime_hour != rtc_editTimeLast.ui8_hours
			|| rtc_editTime_min != rtc_editTimeLast.ui8_minutes)
	{
		rtc_editTimeLast.ui8_minutes = (uint8_t)rtc_editTime_min;
		rtc_editTimeLast.ui8_hours = (uint8_t)rtc_editTime_hour;
		rtc_set_time(&rtc_editTimeLast);
	}
}
